...
const ERC20Helper = require('./coins/tokens/ERC20');
const ERC20Coins = require('./coins/tokens/ERC20coins.json');
...
class AmonLib {
  ...
  addERC20(erc20Data) {
    ...
    this.coinsInstances[`_ETH_${code}`] = new (ERC20Helper.createToken(code))(this.opts);
  }
}
