...
const ERC20EthereumHelper = require('./coins/tokens/ERC20Ethereum');
const ERC20EthereumCoins = require('./coins/tokens/ERC20EthereumCoins.json');
...
class AmonLib {
   ...
   */
  addERC20(erc20Data) {
    const { code, decimals, testnetAddress, mainnetAddress } = erc20Data;

    ERC20EthereumCoins[code] = {
      decimals,
      testnet: testnetAddress,
      mainnet: mainnetAddress,
    };

    this.coinsInstances[`_ETH_${code}`] = new (ERC20EthereumHelper.createToken(code))(this.opts);
  }
}
